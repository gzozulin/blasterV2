...
class SimpleTextTechnique(
    private val windowWidth: Int, private val windowHeight: Int) : GlResource() {
    ...
    private val projectionM = constm4(mat4().ortho(0f, windowWidth.toFloat(), 0f, windowHeight.toFloat(), -1f, 1f))
    private val centerM = constm4(mat4().identity().translate(vec3(windowWidth / 2f, windowHeight / 2f, 0f)))
    ...
    private val simpleTechnique = SimpleTechnique(modelM, centerM, projectionM, result)
