...
fun hitRayList(ray: Expression<ray>, tMin: Expression<Float>, tMax: Expression<Float>, list: Expression<HitableList>) = object : Expression<HitRecord>() {
    override fun expr() = "hitRayList(${ray.expr()}, ${tMin.expr()}, ${tMax.expr()}, ${list.expr()})"
    override fun roots() = listOf(ray, tMin, tMax, list)
}
