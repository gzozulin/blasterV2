...
private const val DEF_DISTRIBUTIONGGX = "float distributionGGX ( vec3 N , vec3 H , float roughness ) { float r2 = roughness * roughness ; float NdotH = max ( dotv3 ( N , H ) , 0.0f ) ; float NdotH2 = NdotH * NdotH ; float nom = r2 ; float denom = ( NdotH2 * ( r2 - 1.0f ) + 1.0f ) ; denom = PI * denom * denom ; return nom / denom ; }\n\n"
