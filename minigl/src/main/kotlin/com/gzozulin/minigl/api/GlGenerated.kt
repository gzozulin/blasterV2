...
private const val DEF_SANDPHYSICS = "vec4 sandPhysics ( vec4 orig ) { return orig ; }\n"
private const val DEF_SANDSOLVER = "vec4 sandSolver ( vec4 orig , vec4 deltas ) { return addv4 ( orig , deltas ) ; }\n"
...
fun sandPhysics(orig: Expression<vec4>) = object : Expression<vec4>() {
    override fun expr() = "sandPhysics(${orig.expr()})"
    override fun roots() = listOf(orig)
}

fun sandSolver(orig: Expression<vec4>, deltas: Expression<vec4>) = object : Expression<vec4>() {
