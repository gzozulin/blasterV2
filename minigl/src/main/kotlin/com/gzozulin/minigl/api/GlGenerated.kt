...
private const val DEF_SPHERES = "vec3 spheres [ 3 ] = { { 0 , 1 , 6 } , { 1 , 1 , 6 } , { - 1 , 1 , 6 } } ;\n"
private const val DEF_GETDIST = "float getDist ( vec3 p ) { float sphereDist0 = lenv3 ( subv3 ( p , spheres [ 0 ] ) ) - 1.0f ; float sphereDist1 = lenv3 ( subv3 ( p , spheres [ 1 ] ) ) - 1.0f ; float sphereDist2 = lenv3 ( subv3 ( p , spheres [ 2 ] ) ) - 1.0f ; float planeDist = p . y ; float d = minf ( minf ( minf ( sphereDist0 , sphereDist1 ) , sphereDist2 ) , planeDist ) ; return d ; }\n"
...
const val CONST_DEF = DEF_PI+DEF_BOUNCE_ERR+DEF_NO_HIT+DEF_NO_SCATTER+DEF_NO_REFRACT+DEF_TYPE_EMPTY+DEF_TYPE_SAND+DEF_TYPE_WATER+DEF_MAX_STEPS+DEF_MAX_DIST+DEF_SURF_DIST+DEF_SPHERES
